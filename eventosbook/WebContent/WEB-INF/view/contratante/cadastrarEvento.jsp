						...
						<div class="tab-pane" id="tab_7">
							<div class="portlet box green ">
								<div class="portlet-title">
									<div class="caption">
										<i class="glyphicon glyphicon-list-alt"></i>Cadastrar Novo
										Evento
									</div>
								</div>
								<div class="portlet-body form">
									<!-- BEGIN FORM-->
									<form action="<%=BibliotecaUrl.getInstance().getUrl(Constantes.LINK_CONTRATANTE_CONTROLADOR, Constantes.LINK_EFETUAR_CADASTRO_EVENTO)%>"
										id="form_sample_2"
										...
										<div class="form-body">
													...
													<div class="input-icon right">
														<i class="fa"></i> <select
															...
															<c:forEach items="${listaTipoEvento}" var="tipoEvento">
																<option value="${tipoEvento.codigo}">
																	${tipoEvento.descricao}</option>
															</c:forEach>
														</select>
													</div>
												</div>
												...
												<div class="col-md-9">
													<div class="input-icon right">
														<i class="fa"></i> <input type="text" id="campoData"
															class="form-control" placeholder="dd/mm/yyyy" name="data"
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													<div class="input-icon right">
														<i class="fa"></i> <input type="text" id="campoHora"
															class="form-control" placeholder="hh:mm" name="hora">
													</div>
												</div>
											</div>
										</div>
										<div class="form-actions">
											<div class="row">
												<div class="col-md-offset-3 col-md-9">
													<button type="submit" class="btn blue-book ">
