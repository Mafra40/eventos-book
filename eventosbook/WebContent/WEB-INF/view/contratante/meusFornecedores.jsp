...
<head>
<meta charset="utf-8" />
<title>EventosBook | Meus Fornecedores</title>
...
<link
	...
	rel="stylesheet" type="text/css" />
<link
	href="<c:url value = "/resources/metronic/assets/admin/pages/css/todo.css"/>"
	rel="stylesheet" type="text/css" />
<!-- END THEME STYLES -->
			...
			<div class="page-content">
				...
				<div class="page-head">
					...
					<div class="page-title">
						<h1>
							Meus Fornecedores <small>Visualize seus Fornecedores</small>
						</h1>
					</div>
					<!-- END PAGE TITLE -->
				...
				<ul class="page-breadcrumb breadcrumb">
					...
					<li><a href="<%=BibliotecaUrl.getInstance().getUrl(Constantes.LINK_CONTRATANTE_CONTROLADOR, Constantes.LINK_EXIBIR_MEUS_FORNECEDORES)%>">Meus
							Fornecedores</a> <i class="fa fa-circle"></i></li>
					...
					<div class="col-md-12">
						...
						<div class="portlet light">
							<div class="portlet-title tabbable-line">
								<div class="caption">
									<i class="glyphicon glyphicon-plane font-red-thunderbird"></i>
									<span class="caption-subject font-blue-madison bold uppercase">Meus
										Fornecedores</span> <span class="caption-helper">Aqui você
										pode ver todos os fornecedores que você adicionou a lista de
										meus fornecedores, aprovite para avalia-los.</span>
								</div>
								...
								<div class="tab-content">
									<div class="tab-pane active" id="portlet_tab1">
										...
										<table class="table table-striped table-bordered table-hover"
											...
											<tbody>
												<c:forEach items="${MeusFornecedores}" var="lista">
													<tr>
														<td>${lista.codigo}</td>
														<td><div class="todo-tasklist">
																<div class="todo-tasklist-item ">
																	...
																	<c:forEach items="${imagem}" var="img">
																		<c:choose>
																			<c:when
																				test='${ not empty img && img.usuario.codigo eq lista.fornecedor.usuario.codigo}'>
																				<img class="todo-userpic pull-left"
																					src="${img.caminho}" height="50px" width="50px">
																			</c:when>
																	...
																	<div class="todo-tasklist-item-title">
																		${lista.fornecedor.nome}</div>
																	<div class="todo-tasklist-item-text">Evento
																		${lista.evento.descricao}</div>
																	<div class="todo-tasklist-controls pull-left">
																		<span class="todo-tasklist-date"><i
																			class="fa fa-calendar"></i>Data Orçamento: <fmt:formatDate
																				value='${lista.dataInclusao}' type='both'
																		...
																		<ul class="item-status stars list-inline">
																			...
																			<li><span style="margin-top: -5px;"
																				class="badge badge-primary badge-roundless">Bom
																			</span></li>
																		</ul>
														...
														<td><a
															href="<%=BibliotecaUrl.getInstance().getUrl(Constantes.LINK_CONTRATANTE_CONTROLADOR, Constantes.LINK_AVALIAR_FORNECEDOR)%>?idMeuFornecedor=${lista.codigo}"
															title="Avaliar este fornecedor" class="btn blue-book "><i
																class="fa fa-usd"></i> Avaliar</a></td>
													</tr>
												</c:forEach>
											</tbody>
										</table>
						...
						<!-- <div class="form-actions">
							<a href="<%=BibliotecaUrl.getInstance().getUrl(Constantes.LINK_CONTRATANTE_CONTROLADOR, Constantes.LINK_BUSCAR_FORNECEDOR)%>"
								class="btn blue-book btn-block">Buscar Fornecedores</a>
						</div>-->
